...
const initialState = {
    infos: [
        ...
        {
            title: {
                bengali: `hit increasable`,
                english: `hit increaseable`
            },
            description: {
                bengali: `আপনি চাইলে আপনার বোর্ড এ হিট increasable enable রাখতে পারেন যদি রাখেন তাহলে ওপর প্লেয়ার যদি ২X দেয় যদি ২x হিট থাকে ২ডলার তাহলে আপনার বেলায় ১x হিট হবে ২ডলার এবং ২ক্স হিট হবে ৪ডলার`,
                english: `If you want, you can enable hit increasable on your board. If you keep it, then if the player gives 2x, if 2x hit is 2 dollars, then 1x hit will be 2 dollars and 2x hits will be 4 dollars.`
            }
        },
        {
            title: {
                bengali: `hit comapreable`,
                english: `hit comapreable`
            },
            description: {
                bengali: `আপনি চাইলে আপনার বোর্ড এ হিট compareable enable রাখতে পারেন যদি রাখেন। যদি খেলার সময় আপনার  একাউন্ট এ পর্যাপ্ত পরিমান  টাকা না থাকে তাহলে আপনার card সকল প্লেয়ার দের সাথে তুলনা করা হবে যদি আপনি বিজয়ী হন তাহলে সেই বোর্ড এর সকল টাকা আপনার একাউন্ট এ যোগ যবে এবং বোর্ড balance জিরো হয়ে খেলা চলতে থাকবে। `,
                english: `If you want you can keep heat compareable enable on your board. If you don't have enough money in your account during the game, then your card will be compared with all the players. If you win, all the money of that board will be added to your account and the game will continue with the board balance being zero.`
            }
        },
        {
            title: {
        ...
        },
        {
            ...
            description: {
                bengali: `আপনি চাইলে বোর্ড এর schedule নির্ধারণ করতে পারবেন যে বোর্ড কয়টায় চালু হবে বা কোন সময়ে বোর্ড চালু হবে।  `,
                english: `If you want, you can determine the schedule of the board at what time the board will be launched or at what time the board will be launched`
            }
        },    
        {
            title: {
